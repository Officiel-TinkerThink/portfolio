...
export const projects = [
  ...
  { name: 'AI Interview — Beaverhand', cat: 'AI / Agents', img: '/portfolio/img/projects/beaverhand.svg', desc: 'Job portal that connects job seekers and employers — and runs the interview itself. Our AI interviewer talks to candidates 24/7, scores what they can actually do, then hands a verified report to a human who makes the final call. 34,000+ open roles across healthcare, legal, tech & trades.', url: 'https://beaverhand.com/' },
  { name: 'Data Analyst Agent', cat: 'AI / Agents', img: '/portfolio/img/projects/data-analyst.svg', desc: 'An agentic data-analysis assistant that turns raw business data into insights and reports on demand. Currently in development for a client — details under NDA.', url: '' },
