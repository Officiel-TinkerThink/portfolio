...
export const projects = [
  ...
  { name: 'AKIRA — AI Knowledge Repository', cat: 'AI / Agents', tags: ['hot'], img: '/portfolio/img/projects/akira.svg', desc: 'Pipeline that continuously cleans, chunks, embeds and indexes verified docs into a vector DB, evaluating indexing quality via RAG metrics for a trustworthy knowledge base.', url: 'https://github.com/Officiel-TinkerThink' },
